...
app.config['JWT_ACCESS_TOKEN_EXPIRES'] = timedelta(days=30)  # set the token expiration time
jwt = JWTManager(app)
...
def gpt(user_data, question, conversation, model="gpt-4", temperature=0.7, max_tokens=6000):
    """
